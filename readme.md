...
-   **[Instructions](docs/install.md)** for installing the TextUML Toolkit. Note you can also
    use TextUML in
...
-   **[TextUML Structural
    Notation](docs/structure.md "TextUML Guide")**
    - a reference guide to the TextUML notation for **structural**
    modeling.

-   **[TextUML Behavioral
    Notation](docs/behavior.md "TextUML Action Language")**
    - a reference guide to the TextUML notation for **behavioral**
    modeling (a.k.a. action language).

-   **[TextUML Toolkit
    features](docs/features.md "TextUML Toolkit Features")**
    - a summary of the features in the TextUML Toolkit, grouped by
    release.

-   **[Repository
    Properties](docs/repository_properties.md "Repository Properties")**
...
-   **[UML 101 with
    TextUML](docs/uml_101.md "UML 101")**
