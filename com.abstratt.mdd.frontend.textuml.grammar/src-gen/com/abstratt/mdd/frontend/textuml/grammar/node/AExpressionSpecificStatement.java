...
public final class AExpressionSpecificStatement extends PSpecificStatement
{
    private PRootExpression _rootExpression_;

    public AExpressionSpecificStatement()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AExpressionSpecificStatement(
            cloneNode(this._rootExpression_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAExpressionSpecificStatement(this);
    }
