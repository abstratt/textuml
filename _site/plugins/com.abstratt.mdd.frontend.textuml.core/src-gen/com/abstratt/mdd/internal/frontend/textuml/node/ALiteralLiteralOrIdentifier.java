...
public final class ALiteralLiteralOrIdentifier extends PLiteralOrIdentifier
{
    private PLiteral _literal_;

    public ALiteralLiteralOrIdentifier()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ALiteralLiteralOrIdentifier(
            cloneNode(this._literal_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseALiteralLiteralOrIdentifier(this);
    }
