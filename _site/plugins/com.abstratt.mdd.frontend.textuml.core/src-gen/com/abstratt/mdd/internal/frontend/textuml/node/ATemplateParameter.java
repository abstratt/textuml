...
public final class ATemplateParameter extends PTemplateParameter
{
    private PQualifiedIdentifier _qualifiedIdentifier_;

    public ATemplateParameter()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ATemplateParameter(
            cloneNode(this._qualifiedIdentifier_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseATemplateParameter(this);
    }
