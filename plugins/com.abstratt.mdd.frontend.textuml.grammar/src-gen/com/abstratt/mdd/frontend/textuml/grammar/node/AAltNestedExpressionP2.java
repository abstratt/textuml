...
public final class AAltNestedExpressionP2 extends PExpressionP2
{
    private PExpressionP1 _expressionP1_;

    public AAltNestedExpressionP2()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AAltNestedExpressionP2(
            cloneNode(this._expressionP1_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAAltNestedExpressionP2(this);
    }
