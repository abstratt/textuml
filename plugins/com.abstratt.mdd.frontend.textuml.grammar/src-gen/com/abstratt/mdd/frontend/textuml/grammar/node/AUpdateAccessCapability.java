...
public final class AUpdateAccessCapability extends PAccessCapability
{
    private TUpdate _update_;

    public AUpdateAccessCapability()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AUpdateAccessCapability(
            cloneNode(this._update_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAUpdateAccessCapability(this);
    }
