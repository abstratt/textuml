...
public final class ACompositionReferenceType extends PReferenceType
{
    private TComposition _composition_;

    public ACompositionReferenceType()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ACompositionReferenceType(
            cloneNode(this._composition_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseACompositionReferenceType(this);
    }
