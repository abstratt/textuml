...
public interface Analysis extends Switch
{
    ...
    void caseARequiredTargetObjectDot(ARequiredTargetObjectDot node);
    void caseAOptionalTargetObjectDot(AOptionalTargetObjectDot node);
    ...
    void caseAAltExpressionP0(AAltExpressionP0 node);
    void caseAAltUnaryExpressionP0(AAltUnaryExpressionP0 node);
    void caseAAltBinaryExpressionP1(AAltBinaryExpressionP1 node);
    void caseAAltNestedExpressionP1(AAltNestedExpressionP1 node);
    void caseAAltBinaryExpressionP2(AAltBinaryExpressionP2 node);
    void caseAAltNestedExpressionP2(AAltNestedExpressionP2 node);
    void caseAAltBinaryExpressionP3(AAltBinaryExpressionP3 node);
    void caseAAltNestedExpressionP3(AAltNestedExpressionP3 node);
    ...
    void caseANotUnaryOpLevel0(ANotUnaryOpLevel0 node);
    void caseAMinusUnaryOpLevel0(AMinusUnaryOpLevel0 node);
    void caseANotNullUnaryOpLevel0(ANotNullUnaryOpLevel0 node);
    void caseARequiredUnaryOpLevel0(ARequiredUnaryOpLevel0 node);
    void caseABinaryOpLevel1(ABinaryOpLevel1 node);
    void caseAMultDivBinaryOpLevel2(AMultDivBinaryOpLevel2 node);
    void caseAElvisBinaryOpLevel2(AElvisBinaryOpLevel2 node);
    void caseABinaryOpLevel3(ABinaryOpLevel3 node);
    void caseABinaryOpLevel4(ABinaryOpLevel4 node);
    void caseABinaryOpLevel5(ABinaryOpLevel5 node);
    ...
    void caseTOptionalDot(TOptionalDot node);
