...
public interface Analysis extends Switch
{
    ...
    void caseAP1Expression(AP1Expression node);
    void caseAP2Expression(AP2Expression node);
    void caseABinaryExpressionP2(ABinaryExpressionP2 node);
    void caseAUnaryExpressionP1(AUnaryExpressionP1 node);
    void caseABinaryExpressionP1(ABinaryExpressionP1 node);
    void caseAOperandExpressionP1(AOperandExpressionP1 node);
    void caseAClosureExpressionP1(AClosureExpressionP1 node);
    void caseAIsClassExpressionP1(AIsClassExpressionP1 node);
    ...
    void caseALogicalBinaryOperatorP1(ALogicalBinaryOperatorP1 node);
    void caseAArithmeticBinaryOperatorP1(AArithmeticBinaryOperatorP1 node);
    void caseALogicalBinaryOperatorP2(ALogicalBinaryOperatorP2 node);
    void caseAArithmeticBinaryOperatorP2(AArithmeticBinaryOperatorP2 node);
    void caseAComparisonBinaryOperatorP2(AComparisonBinaryOperatorP2 node);
    void caseAAndLogicalBinaryOperatorP1(AAndLogicalBinaryOperatorP1 node);
    void caseAOrLogicalBinaryOperatorP2(AOrLogicalBinaryOperatorP2 node);
    void caseAMultArithmeticBinaryOperatorP1(AMultArithmeticBinaryOperatorP1 node);
    void caseADivArithmeticBinaryOperatorP1(ADivArithmeticBinaryOperatorP1 node);
    void caseAPlusArithmeticBinaryOperatorP2(APlusArithmeticBinaryOperatorP2 node);
    void caseAMinusArithmeticBinaryOperatorP2(AMinusArithmeticBinaryOperatorP2 node);
    void caseAIdentityComparisonBinaryOperatorP2(AIdentityComparisonBinaryOperatorP2 node);
    void caseAEqualsComparisonBinaryOperatorP2(AEqualsComparisonBinaryOperatorP2 node);
    void caseANotEqualsComparisonBinaryOperatorP2(ANotEqualsComparisonBinaryOperatorP2 node);
    void caseALowerThanComparisonBinaryOperatorP2(ALowerThanComparisonBinaryOperatorP2 node);
    void caseAGreaterThanComparisonBinaryOperatorP2(AGreaterThanComparisonBinaryOperatorP2 node);
    void caseAGreaterOrEqualsComparisonBinaryOperatorP2(AGreaterOrEqualsComparisonBinaryOperatorP2 node);
    void caseALowerOrEqualsComparisonBinaryOperatorP2(ALowerOrEqualsComparisonBinaryOperatorP2 node);
