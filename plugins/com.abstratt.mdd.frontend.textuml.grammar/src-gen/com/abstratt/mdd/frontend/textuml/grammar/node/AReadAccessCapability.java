...
public final class AReadAccessCapability extends PAccessCapability
{
    private TRead _read_;

    public AReadAccessCapability()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AReadAccessCapability(
            cloneNode(this._read_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAReadAccessCapability(this);
    }
