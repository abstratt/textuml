...
{
    private PConstraintKeyword _constraintKeyword_;
    ...
    public AInvariantKernel(
        @SuppressWarnings("hiding") PConstraintKeyword _constraintKeyword_,
    ...
    {
        // Constructor
        setConstraintKeyword(_constraintKeyword_);
    ...
    public Object clone()
    {
        return new AInvariantKernel(
            cloneNode(this._constraintKeyword_),
    ...
    public PConstraintKeyword getConstraintKeyword()
    {
        return this._constraintKeyword_;
    }

    public void setConstraintKeyword(PConstraintKeyword node)
    {
        if(this._constraintKeyword_ != null)
        {
            this._constraintKeyword_.parent(null);
        }
    ...
    {
        return ""
            + toString(this._constraintKeyword_)
    ...
    {
        // Remove child
        if(this._constraintKeyword_ == child)
        {
            this._constraintKeyword_ = null;
            return;
        }
    ...
    {
        // Replace child
        if(this._constraintKeyword_ == oldChild)
        {
            setConstraintKeyword((PConstraintKeyword) newChild);
            return;
        }
