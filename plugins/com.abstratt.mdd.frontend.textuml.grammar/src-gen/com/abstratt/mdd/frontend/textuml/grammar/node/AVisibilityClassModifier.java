...
public final class AVisibilityClassModifier extends PClassModifier
{
    private PVisibilityModifier _visibilityModifier_;

    public AVisibilityClassModifier()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AVisibilityClassModifier(
            cloneNode(this._visibilityModifier_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAVisibilityClassModifier(this);
    }
