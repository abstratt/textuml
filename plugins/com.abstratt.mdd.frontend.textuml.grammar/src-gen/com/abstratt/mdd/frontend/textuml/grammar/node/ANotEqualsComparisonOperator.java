...
public final class ANotEqualsComparisonOperator extends PComparisonOperator
{
    private TNotEquals _notEquals_;

    public ANotEqualsComparisonOperator()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ANotEqualsComparisonOperator(
            cloneNode(this._notEquals_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseANotEqualsComparisonOperator(this);
    }
