...
public final class ANoneAccessCapabilities extends PAccessCapabilities
{
    private TNone _none_;

    public ANoneAccessCapabilities()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ANoneAccessCapabilities(
            cloneNode(this._none_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseANoneAccessCapabilities(this);
    }
