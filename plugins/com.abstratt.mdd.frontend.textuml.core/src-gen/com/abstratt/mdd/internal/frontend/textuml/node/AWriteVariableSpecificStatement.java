...
public final class AWriteVariableSpecificStatement extends PSpecificStatement
{
    private TIdentifier _identifier_;
    private TAssignop _assignop_;
    private PRootExpression _rootExpression_;

    public AWriteVariableSpecificStatement()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AWriteVariableSpecificStatement(
    ...
    {
        ((Analysis) sw).caseAWriteVariableSpecificStatement(this);
    }
