...
public final class AAnnotationsWithBrackets extends PAnnotationsWithBrackets
{
    private TLBracket _lBracket_;
    private PAnnotationList _annotationList_;
    private TRBracket _rBracket_;

    public AAnnotationsWithBrackets()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AAnnotationsWithBrackets(
    ...
    {
        ((Analysis) sw).caseAAnnotationsWithBrackets(this);
    }
