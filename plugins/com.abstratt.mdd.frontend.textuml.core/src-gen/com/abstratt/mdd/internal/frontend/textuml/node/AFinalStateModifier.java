...
public final class AFinalStateModifier extends PStateModifier
{
    private TFinal _final_;

    public AFinalStateModifier()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AFinalStateModifier(
            cloneNode(this._final_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAFinalStateModifier(this);
    }
