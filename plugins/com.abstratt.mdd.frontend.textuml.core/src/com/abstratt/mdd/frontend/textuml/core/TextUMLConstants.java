...
public interface TextUMLConstants {
    public static String PLUGIN_ID = TextUMLConstants.class.getPackage().getName();
    ...
    String[] KEYWORDS = new String[] { "abstract", "actor", "aggregation", "alias", "and", "any", "apply", "association", "as",
            ...
            "precondition", "primitive", "private", "profile", "property", "protected", "provided", "public", "query", "raise",
            "raises", "read", "readonly", "reception", "reference", "repeat", "required", "return", "role", "self",
            "send", "signal", "specializes", "state", "statemachine", "static", "stereotype", "subsets", "terminate",
            "then", "to", "transition", "true", "try", "type", "unique", "unlink", "unordered", "until", "update",
