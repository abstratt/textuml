...
import com.abstratt.mdd.internal.frontend.textuml.analysis.Analysis;
import com.abstratt.mdd.internal.frontend.textuml.analysis.DepthFirstAdapter;
import com.abstratt.mdd.internal.frontend.textuml.node.AAnnotations;
...
import com.abstratt.mdd.internal.frontend.textuml.node.ABlockNonIfStatement;
import com.abstratt.mdd.internal.frontend.textuml.node.ACast;
...
import com.abstratt.mdd.internal.frontend.textuml.node.AClauseBody;
...
import com.abstratt.mdd.internal.frontend.textuml.node.ANoIfStatementResolved;
import com.abstratt.mdd.internal.frontend.textuml.node.ANonBlockNonIfStatement;
...
import com.abstratt.mdd.internal.frontend.textuml.node.ARootExpression;
...
import com.abstratt.mdd.internal.frontend.textuml.node.ASimpleExpressionBlock;
...
import com.abstratt.mdd.internal.frontend.textuml.node.ATopLevelElement;
import com.abstratt.mdd.internal.frontend.textuml.node.ATransitionDecl;
import com.abstratt.mdd.internal.frontend.textuml.node.ATransitionGuard;
...
import com.abstratt.mdd.internal.frontend.textuml.node.ATupleComponentValueTail;
...
import com.abstratt.mdd.internal.frontend.textuml.node.AVarDeclSection;
import com.abstratt.mdd.internal.frontend.textuml.node.AWhileStatement;
import com.abstratt.mdd.internal.frontend.textuml.node.AWithIfStatementResolved;
...
import com.abstratt.mdd.internal.frontend.textuml.node.PGlobalDirective;
import com.abstratt.mdd.internal.frontend.textuml.node.PParamDeclList;
import com.abstratt.mdd.internal.frontend.textuml.node.TAssignop;
import com.abstratt.mdd.internal.frontend.textuml.node.TColon;
import com.abstratt.mdd.internal.frontend.textuml.node.TComma;
import com.abstratt.mdd.internal.frontend.textuml.node.TComment;
import com.abstratt.mdd.internal.frontend.textuml.node.TModelComment;
import com.abstratt.mdd.internal.frontend.textuml.node.TWhiteSpace;
...
public class TextUMLFormatter {
	...
	public void format(ABinaryExpression node, StringBuilder output, int indentation) {
		format(node.getExpression(), output, indentation);
		addWhitespace(output);
		format(node.getBinaryOperator(), output, indentation);
		addWhitespace(output);
	...
	public void format(AIsClassifiedExpression node, StringBuilder output, int indentation) {
		format(node.getExpression(), output, indentation);
		addWhitespace(output);
		format(node.getIs(), output, indentation);
		addWhitespace(output);
