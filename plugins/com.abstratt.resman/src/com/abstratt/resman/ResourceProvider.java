...
public interface ResourceProvider<K extends ResourceKey> extends ActivatableFeatureProvider {
	Class<K> getTarget();
	/**
	 * Returns a new instance of the resource with the given id. This may be a long running operation as it may involve 
	 * materializing a resource that is not readily available.
	 * 
