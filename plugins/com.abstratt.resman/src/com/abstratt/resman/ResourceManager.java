...
public abstract class ResourceManager<K extends ResourceKey> {
	 ...
	 *
	 * At any time, at most one task may be running within a given resource instance. 
	 * 
	 * If another task is already running within the resource, 
	 * depending on the implementation, one of the following things may happen:
	 * <ul>
	 * <li>the task execution will block until the resource becomes available (potentially timing out)
	 * <li>a new instance of the resource may be created in order to run this task
	 *  
	 * @param resourceId the resource id
	 * @param toRun the task to run
	 * @return the task result
	 * @throws ResourceException if any resource-related errors occur
	 */
	...
	/**
	 * Requests a resource to be removed. Any existing instances of the resource are to be considered stale.
	 * New tasks against the given resource will work on a freshly loaded instance. Currently running tasks
	 * will be dealing with a stale version of the resource until they complete. 
	 *  
