...
/**
 * Enumeration of element types. Maps UML metamodel elements to builder
 * impleementations.
 */
public enum UML2ProductKind {
	ASSOCIATION, CLASS(Literals.CLASS, ClassifierBuilder.class), DATA_TYPE(Literals.DATA_TYPE, ClassifierBuilder.class), INTERFACE(
	        Literals.INTERFACE, ClassifierBuilder.class), PACKAGE(Literals.PACKAGE, PackageBuilder.class), PROFILE(
	        Literals.PROFILE, PackageBuilder.class), MODEL(Literals.MODEL, PackageBuilder.class), ENUMERATION(
	        Literals.ENUMERATION, ClassifierBuilder.class), STEREOTYPE(Literals.STEREOTYPE, ClassifierBuilder.class), CLASSIFIER(
	        Literals.CLASSIFIER, null), PROPERTY, OPERATION, PARAMETER, ADD_VARIABLE_VALUE_ACTION, CALL_OPERATION_ACTION, READ_EXTENT_ACTION, READ_SELF_ACTION, READ_VARIABLE_ACTION, READ_STRUCTURAL_FEATURE_ACTION, STRUCTURED_ACTIVITY_NODE, ACTIVITY, ACTION(
	        Literals.ACTION, null), VARIABLE, ADD_STRUCTURAL_FEATURE_VALUE_ACTION, VALUE_SPECIFICATION_ACTION, LITERAL_BOOLEAN, LITERAL_INTEGER, LITERAL_STRING, LITERAL_UNLIMITED_NATURAL, LITERAL_NULL, BASIC_TYPE_LITERAL(
	        Literals.LITERAL_STRING, BasicTypeValueSpecificationBuilder.class);
	...
	private Class<? extends ElementBuilder<?>> findBuilderClass(String packageName) {
		String metaClassSimpleName = metaClass.getInstanceClass().getSimpleName();
		try {
			return (Class<? extends ElementBuilder<?>>) Class.forName(packageName + '.' + metaClassSimpleName
			        + "Builder");
