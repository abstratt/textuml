 ...
 * source files written in multiple languages. The end result of the compilation
 * is that the source files found in the source locations are parsed into UML
 * models, persisted into the appropriate output location.
 * <p>
 * Internally, the compilation director will build a repository from the
 * existing files found under the model and output paths. Compilers
 * participating in the compilation process will generate model elements into
 * this repository.
 * </p>
 */
