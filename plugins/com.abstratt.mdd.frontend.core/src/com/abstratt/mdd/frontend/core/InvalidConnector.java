...
public class InvalidConnector extends Problem {
	...
	public enum Reason {
		...
		Roles("Roles must be owned by connector parent or by the classifiers of the parts of the connector parent",
		        UMLValidator.CONNECTOR__ROLES), Types(
		        "Connectable elements must conform to the types of the association ends of the association that types the connector",
		        UMLValidator.CONNECTOR__TYPES),
		// not implemented in UML2
		BetweenInterfacesPorts("Port interfaces are not compatible", -1 /*
																		 * UMLValidator
																		 * .
																		 * CONNECTOR_END_BETWEEN_INTERFACES_PORTS
																		 */), Compatible(
		        "The connectable elements attached to the ends of a connector must be compatible", -1 /*
																									 * UMLValidator
																									 * .
